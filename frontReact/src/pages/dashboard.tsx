...
export function Dashboard({ children }: MenuProps) {
                ...
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                <svg
                                    className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-300 dark:group-hover:text-blue-600"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    viewBox="0 0 22 21"
                        ...
                        <li>
                            <a
                                href="#"
                                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-00 dark:hover:bg-gray-200 group"
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75  group-hover:text-gray-300 dark:group-hover:text-blue-600"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    viewBox="0 0 18 18"
                                ...
                                <span className="flex-1 ms-3 text-gray-800 font-semibold dark:group-hover:text-blue-600">Inventario</span>
                        ...
                        <li>
                            ...
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-300 dark:group-hover:text-blue-600"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="flex-1 ms-3 text-gray-800 font-semibold dark:group-hover:text-blue-600">Gestión</span>
                            </a>
                        </li>
                        {/* Sign In */}
                        <li>
